...
public class UserMealRestControllerTest extends AbstractControllerTest {
    ...
    public void testDelete() throws Exception {
        mockMvc.perform(delete(REST_URL + MEAL1_ID).with(TestUtil.userHttpBasic(USER)).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    ...
    public void testUpdate() throws Exception {
        ...
        mockMvc.perform(put(REST_URL + MEAL1_ID).with(TestUtil.userHttpBasic(USER)).contentType(MediaType.APPLICATION_JSON)
