...
public class UserMealRestController extends AbstractUserMealController {
    ...
    ResponseEntity<UserMeal> createWithLocation(@RequestBody UserMeal um) {
        UserMeal created = super.create(um);
    ...
    public List<UserMealWithExceed> getBetween(@RequestParam("from") String sdt, @RequestParam("to") String edt) {
